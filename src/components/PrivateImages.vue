<template>
  <v-app>
    <v-content>
      <v-bottom-navigation :value="activeBtn" color="primary" horizontal>
        ...
        <router-link class="v-btn" to="/userProfile">
         ...
         <router-link class="v-btn" to="/publicimages">
          <span>Public</span>
        </router-link>
    ...
    <h2 class="text-center mt-4"><b class="blue--text">Private Images</b></h2>
    <br />
...
export default {
  ...
  mounted: function () {
    ...
    axios
      .get("http://127.0.0.1:8000/api/image/getAllPrivateImage", {
